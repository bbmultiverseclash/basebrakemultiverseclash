...
const DUNGEON_BANNED_CARDS =[
    ...
    'I Think I Can Make This in LEGO', 'Miyamoto Musashi', 'Skull Devourer', 'Megumin'
];
...
window.buyBossKeyWithGems = function() {
    if ((playerData.gems || 0) < 2) {
        showToast('💎 Gems ไม่พอ! (ต้องการ 2)', '#f87171');
        return;
    }
    playerData.gems -= 2;
    playerData.bossKeys = (playerData.bossKeys || 0) + 1;
    saveData(); updateHubUI(); renderDungeonPanel();
    showToast('🔑 ซื้อ Boss Key ด้วย 2 💎 สำเร็จ!', '#60a5fa');
}
