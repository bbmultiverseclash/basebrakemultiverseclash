...
// Pool for single pulls (equal random) — Hisoka = code-only, Meruem = bundle-only
const HXH_PULL_POOL   = ['Gon','Kurapika','Welfin','Chrollo','Pitou','Netero','Killua','Leorio'];
// All 9 cards for the bundle (including Champion)
...
<div style="background:linear-gradient(135deg,#0d0b2e,#1a0a2e);
  ...
  <div style="padding:14px">
    ...
    <!-- Equal + Exclusive note -->
    <div style="background:rgba(168,85,247,0.1);border:1px solid #4338ca;
         border-radius:10px;padding:6px 10px;margin-bottom:12px;font-size:0.63rem;color:#a5b4fc;text-align:center">
      🎲 Equal Distribution — ทุกการ์ดมีโอกาสเท่ากัน &nbsp;·&nbsp; 🔒 Exclusive — ไม่มีในแพ็คทั่วไป
    </div>
