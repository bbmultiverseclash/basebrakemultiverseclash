...
<div style="background:linear-gradient(135deg,#0d0b2e,#1a0a2e);
  ...
  <div style="padding:14px">
    ...
    <!-- Meruem rare rate + Equal note -->
    <div style="background:linear-gradient(135deg,rgba(234,179,8,0.12),rgba(168,85,247,0.1));border:1px solid #ca8a04;border-radius:10px;padding:7px 10px;margin-bottom:6px;text-align:center">
      <div style="font-size:0.65rem;font-weight:900;color:#fbbf24;margin-bottom:2px">♛ Meruem — Champion (5% rate)</div>
      <div style="font-size:0.6rem;color:#fde68a">ดึงครั้งที่ ${HXH_MAX_PULLS} การันตี Meruem ถ้ายังไม่ได้! · เหลือ ${Math.max(0,HXH_MAX_PULLS-pulled)} ครั้ง</div>
    </div>
    <div style="background:rgba(168,85,247,0.1);border:1px solid #4338ca;border-radius:10px;padding:6px 10px;margin-bottom:12px;font-size:0.63rem;color:#a5b4fc;text-align:center">
      🎲 การ์ดอื่น 8 ใบ: Equal Rate · 🔒 Exclusive — ไม่มีในแพ็คทั่วไป
    </div>
...
<div style="background:rgba(251,191,36,0.06);border:1px solid #92400e55;
  ...
  🎣 <strong>Fishing Rod Token</strong> — สะสมสำหรับร้านตกปลาที่กำลังจะมาในอนาคต! (คุณมี ${rod} Rod)
</div>`;
