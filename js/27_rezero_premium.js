        ...
        window.initiateAttack = function(atkId, tgtId, isBase) {
            ...
            if (attacker && target) {
                ...
                if (attacker.items && attacker.items.some(i => i.name === 'Masayume')) {
                    ...
                    if (tgtAfter && tgtAfter.hp > 0 && prevTgtHp > tgtAfter.hp) {
                        tgtAfter.hp = -99;
    ...
    window.startDungeon_v2 = function(dungeonId) {
        ...
        window.buildDeck = function(theme) {
            if (theme === 'dungeon_boss') {
                ...
                // 10 Wild Kingdom (Cost 3)
                for (let i = 0; i < 10; i++) bossDeck.push(makeBossCard('Wild Kingdom', 'animal_kingdom', 3, 0));
