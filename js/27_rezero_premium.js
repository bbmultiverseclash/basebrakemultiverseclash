...
Object.assign(REZERO_CARDS, {
    'Beatrice':               { name:'Beatrice',               type:'Character', cost:6,  atk:2,  hp:6,  maxHp:6,  shopOnly:true, text:'On Reveal/Death: สร้าง 2 "Contract" ขึ้นมือ | Contract (2): ยูนิตเรา +3 ATK เทิร์นนี้ ถ้าตาย Heal Base +1',                                       color:'bg-pink-700',           art:'https://i.pinimg.com/736x/73/c7/18/73c7188737ff429a89826bbfbb0dc637.jpg', _theme:'isekai_adventure' },
    'Sirius':                 { name:'Sirius',                 type:'Character', cost:7,  atk:5,  hp:6,  maxHp:6,  shopOnly:true, text:'Ongoing: ลดดาเมจรับ 30% | Attack: Paralyze 2 เทิร์น (ถ้าเป้าติดอัมพาตอยู่แล้ว +2 DMG)',                                                           color:'bg-red-600',            art:'https://i.pinimg.com/736x/ae/23/b0/ae23b026a8b9231b230baf0185325448.jpg', _theme:'isekai_adventure' },
    'Echidna':                { name:'Echidna',                type:'Character', cost:8,  atk:3,  hp:5,  maxHp:5,  shopOnly:true, text:'Ongoing: ทุกครั้งที่จั่ว +2 ATK/HP | ถ้ามีเพื่อน 2+ ใบ จั่วเพิ่ม 2 ใบทุกเริ่มเทิร์น',                                                             color:'bg-gray-800',           art:'https://i.pinimg.com/736x/2f/4d/94/2f4d943524fee3ba120775ef2f3c77ff.jpg', _theme:'isekai_adventure' },
    'Garfiel Tinsel':         { name:'Garfiel Tinsel',         type:'Character', cost:5,  atk:4,  hp:4,  maxHp:4,  shopOnly:true, text:'Summon: สร้าง "Beastification" | Beastification (5): -1 Base HP เพื่อบัฟตัวเอง +5/+5 และ 50% Evade',                                               color:'bg-orange-600',         art:'https://file.garden/aeeLCXSsJxTPrRbp/c1b5646f55fa2bd35a7e44d71acbe254.jpg', _theme:'isekai_adventure' },
    'Pandora':                { name:'Pandora',                type:'Character', cost:10, atk:5,  hp:8,  maxHp:8,  shopOnly:true, text:'Reveal: สุ่มอัมพาต 1 ศัตรู 2 เทิร์น | Attack: -1 Base HP เรา (ฆ่าได้ Heal 2) | Death: คืนชีพ 1 ครั้ง',                                             color:'bg-indigo-100 text-black', art:'https://file.garden/aeeLCXSsJxTPrRbp/11a28ae8bc6b2df3cbb14814a6b5cac6.jpg', _theme:'isekai_adventure' },
    'Regulus Corneas':        { name:'Regulus Corneas',        type:'Character', cost:9,  atk:4,  hp:5,  maxHp:5,  shopOnly:true, text:'Summon/End Turn: สุ่มมาร์คเพื่อน 1 ตัว (ลับ) | ตราบใดที่มีมาร์คในสนาม Regulus อมตะต่อทุกอย่าง',                                                   color:'bg-yellow-100 text-black', art:'https://file.garden/aeeLCXSsJxTPrRbp/66fb74aebbe3356c5d286f5ca157856d.jpg', _theme:'isekai_adventure' },
    'Petelgeuse Romanée-Conti':{ name:'Petelgeuse Romanée-Conti', type:'Character', cost:8, atk:5, hp:3, maxHp:3, shopOnly:true, text:'Summon: สร้าง 2 "Shadow Hand" (1/1 Taunt) | Death: ยึดร่างศัตรูที่อ่อนแอกว่าเพื่อคืนชีพ',                                                         color:'bg-green-900',          art:'https://file.garden/aeeLCXSsJxTPrRbp/ad7fab8c82685a6fd74d4a500e3879d2.jpg', _theme:'isekai_adventure' },
    'Otto Suwen':             { name:'Otto Suwen',             type:'Character', cost:4,  atk:2,  hp:3,  maxHp:3,  shopOnly:true, text:'Summon: เรียก Character จากชุด Animal Kingdom จากเด็คลงสนามทันที',                                                                                   color:'bg-green-600',          art:'https://file.garden/aeeLCXSsJxTPrRbp/23f463ab3d5f6947eb8a7f9dd5dd2c68.jpg', _theme:'isekai_adventure' },
    'Cecilus Segmunt':        { name:'Cecilus Segmunt',        type:'Character', cost:9,  atk:4,  hp:8,  maxHp:8,  shopOnly:true, text:'Summon: รับดาบ Murasame และ Masayume | ดาบจะถูกลงตามเลือดฐาน (Base HP) ที่เสียไป',                                                                  color:'bg-blue-800',           art:'https://file.garden/aeeLCXSsJxTPrRbp/b8716bb23421d77b388b401b0b8a7c7e.jpg', _theme:'isekai_adventure' },
    'Satella':                { name:'Satella',                type:'Character', cost:10, atk:12, hp:12, maxHp:12, shopOnly:true, text:'Summon: อัมพาตศัตรูทั้งหมด 1 เทิร์น | Death: อมตะ/ลอยตัวในเทิร์นหน้าแล้วคืนชีพเต็ม',                                                              color:'bg-gray-950',           art:'https://file.garden/aeeLCXSsJxTPrRbp/3b90ce1ced967cafc3add6c85f8cb997.jpg', _theme:'isekai_adventure' },
});
