...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const REZERO_EVOLVED = {
        'Subaru v2': {
            ...
            art: 'https://file.garden/aeeLCXSsJxTPrRbp/3a2824ffd52f9b7d616e804887817289.jpg', _theme: 'isekai_adventure'
        },
            ...
            for (let i = p.field.length - 1; i >= 0; i--) {
                ...
                if (getCharStats(c).hp <= 0 && !c.isDyingProcessing) {
                    ...
                    if (effName === 'Subaru v2') {
                        ...
                        c.status = [];              // ล้างสถานะ Poison/Burn/Bleed
                        c.attacksLeft = 0;
                        c.isDyingProcessing = false; // ล้างสถานะกำลังตายก่อนกลับขึ้นมือ
                        p.field.splice(i, 1);
                        p.hand.push(c);
