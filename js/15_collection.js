...
function showCardDetailModal(name, theme) {
    ...
    modal.style.cssText = `position:absolute;top:${_sy}px;left:${_sx}px;width:${_vw}px;height:${_vh}px;background:rgba(0,0,0,0.88);z-index:99999;display:flex;align-items:center;justify-content:center;box-sizing:border-box`;
