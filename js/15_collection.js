...
async function redeemCode() {
    ...
    if (reward.serverClaim) {
        // Block locally first — prevents repeat attempts if already claimed on this device
        ...
        try {
            // applyLocally:false forces a real server round-trip — prevents false commits from local cache
            ...
            msg.style.color='#f87171'; msg.textContent='❌ เกิดข้อผิดพลาด กรุณาลองใหม่'; console.error('Redeem error:', e);
        }
        return;
    }
