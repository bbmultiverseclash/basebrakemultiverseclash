...
function showCardDetailModal(name, theme) {
    ...
    modal.style.cssText = 'position:fixed;top:0;left:0;right:0;bottom:0;width:100%;height:100%;background:rgba(0,0,0,0.88);z-index:99998;display:flex;align-items:center;justify-content:center;box-sizing:border-box;';
    ...
    <div style="background:linear-gradient(135deg,#0f0c29,#1a1640,#1e1b4b);border:3px solid ${borderColor};border-radius:24px;
      ...
      <div style="padding:16px 18px">
        ...
        <div style="background:linear-gradient(135deg,rgba(245,158,11,0.08),rgba(251,191,36,0.05));
          ...
          <div style="font-size:0.8rem;color:#d1d5db;line-height:1.6">${lore.lore}</div>
        </div>` : ''}
