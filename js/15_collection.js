...
function showCardDetailModal(name, theme) {
    ...
    // Fix: ใช้ window.innerWidth/Height กัน horizontal scroll ดัน modal ออกนอกจอ
    window.scrollTo(0, window.scrollY);
    modal.style.cssText = `position:fixed;top:0;left:0;width:${window.innerWidth}px;height:${window.innerHeight}px;background:rgba(0,0,0,0.88);z-index:99998;display:flex;align-items:center;justify-content:center;box-sizing:border-box;padding:0 16px;`;
