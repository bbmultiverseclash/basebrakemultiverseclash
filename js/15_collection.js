      ...
      <div style="display:flex;gap:16px;justify-content:center;margin-bottom:20px">
        <div style="text-align:center">
          <div style="width:90px;height:130px;border-radius:12px;overflow:hidden;border:3px solid #10b981;box-shadow:0 0 20px rgba(16,185,129,0.5);margin:0 auto 6px">
            <img src="https://files.catbox.moe/3yzn5t.jpg" style="width:100%;height:75%;object-fit:cover" onerror="this.style.display='none'">
...
function showCardDetailModal(name, theme) {
    ...
    modal.style.cssText = 'position:fixed;top:0;left:0;width:100vw;height:100vh;background:rgba(0,0,0,0.88);z-index:8000;display:flex;align-items:center;justify-content:center;animation:fadeIn 0.25s ease;box-sizing:border-box';
    ...
    <div style="background:linear-gradient(135deg,#0f0c29,#1a1640,#1e1b4b);border:3px solid ${borderColor};border-radius:24px;
         padding:0;max-width:420px;width:90%;max-height:90vh;overflow-y:auto;
         box-shadow:0 0 60px ${glowColor};position:relative">
      ...
      <div style="padding:16px 18px">
        ...
        <div style="background:#111827;border-radius:12px;padding:12px 14px;margin-bottom:12px;border:1px solid ${borderColor}33">
          ...
          <div style="font-size:0.82rem;color:#e5e7eb;line-height:1.5">${data.text}</div>
        </div>` : ''}
        ...
        <div style="background:linear-gradient(135deg,rgba(245,158,11,0.08),rgba(251,191,36,0.05));
          ...
          <div style="font-size:0.8rem;color:#d1d5db;line-height:1.6;font-style:italic;text-align:center">"${lore.lore}"</div>
        </div>` : ''}
