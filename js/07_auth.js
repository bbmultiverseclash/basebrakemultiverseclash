...
// ============================================================
        ...
        async function googleLogin() {
            ...
            try {
                ...
                // [FIX] ใช้ signInWithRedirect แทน signInWithPopup
                // เพราะ Mobile browser บล็อก Popup เกือบทุกเจ้า
                await firebase.auth().signInWithRedirect(provider);
                // หน้าจะ redirect ไป Google แล้วกลับมา
                // onAuthStateChanged + getRedirectResult ใน initAuth() จะจัดการต่อ
            } catch(e) {
