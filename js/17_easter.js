...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typeof _origEndGame === 'function') {
        window.endGame = function(winner) {
            ...
            // [FIX] ตรวจเฉพาะ _isRabbitRampantGame — flag นี้ถูก set ใน buildDeck('easter') เท่านั้น
            // ดังนั้นมั่นใจ 100% ว่า AI deck เป็น 65 Great Rabbits จริงๆ ไม่ใช่ Easter deck แบบอื่น
