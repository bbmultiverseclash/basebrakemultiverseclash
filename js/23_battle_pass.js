...
// ============================================================
const SUNSK_EXPIRY = new Date('2026-05-15T00:00:00+07:00').getTime();
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // [FIXED] โหลดเข้า ARTSTYLE_CFG โดยตรง
    if (typeof ARTSTYLE_CFG !== 'undefined') {
        ARTSTYLE_CFG['pongneng_katakuri'] = {
    ...
    if (typeof window.renderBattlePass === 'function') {
        ...
        window.renderBattlePass = function() {
            _origRenderBP.apply(this, arguments);
...
window.buySunskBPPack = function() {
    ...
    // [FIXED] มอบ 10,000 BP (เรียกใช้ฟังก์ชันเพื่อให้เลเวลอัปอัตโนมัติ)
    if (typeof window.addBattlePoints === 'function') {
        window.addBattlePoints(10000);
    } else {
        playerData.bpPoints = (playerData.bpPoints || 0) + 10000;
    }

    // บันทึกข้อมูลและรีเฟรชหน้า
    if (typeof saveData === 'function') saveData();
    if (typeof updateHubUI === 'function') updateHubUI();
