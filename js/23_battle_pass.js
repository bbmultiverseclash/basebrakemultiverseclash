...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const JJK_EVOLVED = {
        ...
        // Spells for Gojo
        'Ao (Evolved)': { name: 'Ao (Evolved)', type: 'Spell', cost: 4, text: '2 ดาเมจ ใส่ศัตรูสุ่ม 2 ตัว + แช่แข็ง(Freeze) 1 เทิร์น (ทั้งเทิร์นเขาและเรา)', color: 'bg-blue-600', requiresTarget: false, _theme: 'jjk', isEvGojoSpell: true },
        'Aka (Evolved)': { name: 'Aka (Evolved)', type: 'Spell', cost: 5, text: '3 ดาเมจ ใส่ศัตรูสุ่ม 3 ตัว', color: 'bg-red-600', requiresTarget: false, _theme: 'jjk', isEvGojoSpell: true },
        'Murasaki (Evolved)': { name: 'Murasaki (Evolved)', type: 'Spell', cost: 8, text: 'ทำลายการ์ดบนสนามฝั่งศัตรูทั้งหมดทันที', color: 'bg-purple-700', requiresTarget: false, _theme: 'jjk', isEvGojoSpell: true },
        'Unlimited Void': { name: 'Unlimited Void', type: 'Field', cost: 9, text: 'Ultimate Field | จบเทิร์น: 50% โอกาสทำให้ศัตรู 1-5 ตัว ติด Paralyze 2 เทิร์น', color: 'bg-slate-900', isUltimateField: true, _theme: 'jjk' },
        // Spells for Sukuna
        'Cleave (Evolved)': { name: 'Cleave (Evolved)', type: 'Spell', cost: 5, text: 'ทำ 8 ดาเมจ ใส่ศัตรูสุ่ม 1 ตัว', color: 'bg-red-800', requiresTarget: false, _theme: 'jjk', isEvSukunaSpell: true },
        'Summon Mahoraga': { name: 'Summon Mahoraga', type: 'Spell', cost: 4, text: 'อัญเชิญ Mahoraga ลงสู่สนาม', color: 'bg-zinc-700', requiresTarget: false, _theme: 'jjk', isEvSukunaSpell: true }
    };
