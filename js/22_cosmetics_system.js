...
function syncBPCosmetics() {
    ...
    if (playerData.bpClaimedFree && playerData.bpClaimedFree.includes(5)) {
        if (!playerData.unlockedCosmetics.includes('av_yuji')) playerData.unlockedCosmetics.push('av_yuji');
    }
    if (playerData.bpClaimedFree && playerData.bpClaimedFree.includes(15)) {
        if (!playerData.unlockedCosmetics.includes('bn_today')) playerData.unlockedCosmetics.push('bn_today');
    }
    if (playerData.bpClaimedPremium && playerData.bpClaimedPremium.includes(1)) {
        if (!playerData.unlockedCosmetics.includes('av_yuta')) playerData.unlockedCosmetics.push('av_yuta');
    }
    if (playerData.bpClaimedPremium && playerData.bpClaimedPremium.includes(15)) {
        if (!playerData.unlockedCosmetics.includes('bn_history')) playerData.unlockedCosmetics.push('bn_history');
    }
    saveData();
}
