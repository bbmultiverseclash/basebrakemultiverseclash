...
const ONE_PIECE_CARDS = {
    ...
    'Eustass Kid': {
        ...
        art: 'https://i.pinimg.com/1200x/4f/55/a8/4f55a8d5c4b02f9e7e3d6a8c1f2b3e4d.jpg',
        _theme: 'one_piece'
    },
    ...
    'Ryokugyu': {
        ...
        art: 'https://i.pinimg.com/1200x/7a/bc/d1/7abcd1e2f3a4b5c6d7e8f9a0b1c2d3e4.jpg',
        _theme: 'one_piece'
    },
    ...
    'God Baki': {
        ...
        art: 'https://i.pinimg.com/1200x/2c/3d/4e/2c3d4e5f6a7b8c9d0e1f2a3b4c5d6e7f.jpg',
        _theme: 'one_piece'
    },
    ...
    'King the Wildfire': {
        ...
        art: 'https://i.pinimg.com/1200x/9e/0f/1a/9e0f1a2b3c4d5e6f7a8b9c0d1e2f3a4b.jpg',
        _theme: 'one_piece'
    },
    ...
    'Yamato': {
        ...
        art: 'https://i.pinimg.com/1200x/3b/4c/5d/3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e.jpg',
        _theme: 'one_piece'
    }
};
...
window.openOnePieceMiniShop = function() {
    ...
    const cardRows = OP_CARD_NAMES.map(name => {
        ...
        <div style="background:#0f172a;border:1.5px solid #f97316;border-radius:14px;padding:10px;display:flex;align-items:flex-start;gap:10px;margin-bottom:8px">
            <div style="width:56px;height:70px;flex-shrink:0;border-radius:8px;overflow:hidden;border:2px solid #f97316;background:#1f2937;display:flex;align-items:center;justify-content:center;font-size:1.8rem">🏴‍☠️</div>
